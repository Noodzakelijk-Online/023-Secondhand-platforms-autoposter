...
| TD-004 | High | Data deletion/privacy | 30 | Export exists, but account deletion, user data purge, and audit log controls are incomplete. | Add owner-scoped account delete UI, user data delete endpoint, and audit event model. |
