...
| TD-012 | Medium | Accessibility/browser QA | 54 | Automated static accessibility smoke checks and Chromium UI/UX debugging rounds exist, but keyboard, zoom, screen-reader, and full responsive/cross-browser evidence is not captured. | Run the remaining checklist in `docs/BROWSER_ACCESSIBILITY_QA.md` and capture findings. |
